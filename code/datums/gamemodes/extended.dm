/datum/game_mode/extended
	...
	valid_job_types = list(
		...
		/datum/job/terragov/engineering/tech = 4,
		...
		/datum/job/terragov/security/mp_commander = 1,
		/datum/job/terragov/security/mp_officer = 4,
		/datum/job/terragov/security/prisoner = 4,
