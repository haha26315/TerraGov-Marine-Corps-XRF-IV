...
#define JOB_DISPLAY_ORDER_MP_COMMANDER 5
#define JOB_DISPLAY_ORDER_MP_OFFICER 6
#define JOB_DISPLAY_ORDER_STAFF_OFFICER 7
#define JOB_DISPLAY_ORDER_PILOT_OFFICER 8
#define JOB_DISPLAY_ORDER_MECH_PILOT 9
...
#define JOB_DISPLAY_ORDER_MP_OFFICER 19
...
#define MP_COMMANDER "MP Commander"
...
GLOBAL_LIST_INIT(jobs_officers, list(CAPTAIN, FIELD_COMMANDER, MP_COMMANDER, MP_OFFICER, STAFF_OFFICER, PILOT_OFFICER, MECH_PILOT, CORPORATE_LIAISON, SYNTHETIC, SILICON_AI))
...
GLOBAL_LIST_INIT(jobs_regular_all, list(CAPTAIN, FIELD_COMMANDER, MP_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, MECH_PILOT, REQUISITIONS_OFFICER, CHIEF_SHIP_ENGINEER, \
CHIEF_MEDICAL_OFFICER, SYNTHETIC, SILICON_AI, CORPORATE_LIAISON, SHIP_TECH, \
MEDICAL_DOCTOR, MEDICAL_RESEARCHER, SQUAD_LEADER, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE, MP_OFFICER, \
