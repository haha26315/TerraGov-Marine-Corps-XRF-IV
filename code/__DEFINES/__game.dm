...
#define GAME_YEAR (text2num(time2text(world.realtime, "YYYY")) + 220)


#define MAX_MESSAGE_LEN 10240
#define MAX_PAPER_MESSAGE_LEN 10240
#define MAX_BOOK_MESSAGE_LEN 10240
#define MAX_NAME_LEN 26
#define MAX_BROADCAST_LEN 1024
