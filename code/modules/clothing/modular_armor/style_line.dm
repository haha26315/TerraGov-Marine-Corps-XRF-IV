...
/obj/item/clothing/head/modular/style/beret
	name = "Sol Fed beret"
	desc = "A hat used by the Solarian Federation, typically considered the most iconic military headgear. Often reserved for higher ranking officers, they occasionally they find their way down the ranks into the hands of squad-leaders and decorated grunts."
...
/obj/item/clothing/head/modular/style/classic_beret
	name = "Sol Fed beret (classic)"
	desc = "A hat used by the Solarian Federation, typically considered the most iconic military headgear. Often reserved for higher ranking officers, they occasionally they find their way down the ranks into the hands of squad-leaders and decorated grunts. This one is in a classic style."
...
/obj/item/clothing/head/modular/style/boonie
	name = "Sol Fed boonie"
	desc = "A boonie hat used by the Sol Fed, purpose made for operations in enviroments with a lot of sun, or dense vegetation."
	icon_state = "boonie_inhand"
	item_state = "boonie"

/obj/item/clothing/head/modular/style/cap
	name = "Sol Fed cap"
	desc = "A common patrol cap used by the Solarian Federation, stylish and comes in many colors. Mostly useful to keep the sun and officers away."
	icon_state = "cap_inhand"
	item_state = "cap"


/obj/item/clothing/head/modular/style/slouchhat
	name = "Sol Fed slouch hat"
	desc = "A slouch hat, makes you feel down under, doesn't it? Has 'PROPERTY OF THE SOLARIAN FEDERATION' markings under the hat."
	icon_state = "slouch_inhand"
	item_state = "slouch"

/obj/item/clothing/head/modular/style/ushanka
	name = "Sol Fed ushanka"
	desc = "A comfortable ushanka used by the Solarian Federation. Will keep you warm in even the most harshest artic enviroments."
...
/obj/item/clothing/head/modular/style/bandana
	name = "Sol Fed bandana"
	desc = "A bandana that goes on your head. Has Solarian Federation markings on the back tie, and it seems that the knot will never come undone somehow."
