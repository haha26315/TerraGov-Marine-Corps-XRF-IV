...
/obj/item/clothing/suit/storage/marine
	...
	desc = "A standard Solarian Federation M3 Pattern Chestplate. Protects the chest from ballistic rounds, bladed objects and accidents. It has a small leather pouch strapped to it for limited storage."
...
/obj/item/clothing/suit/storage/marine/officer/req
	...
	desc = "A standard Solarian Federation N2 Personal Armor System. Protects the chest from ballistic rounds, bladed objects and accidents. It has a small leather pouch strapped to it for limited storage."
	icon_state = "mp"
...
/obj/item/clothing/suit/storage/faction/UPP
	...
	desc = "Standard body armor of the USL pirates, the UM5 (United Medium MK5) is a medium body armor, roughly on par with the venerable M3 pattern body armor in service with the Solarian Federation."
...
/obj/item/clothing/suit/storage/faction/freelancer
	...
	desc = "A armored protective chestplate scrapped together from various plates. It keeps up remarkably well, as the craftsmanship is solid, and the design mirrors such armors in the UPP and the Solarian Federation."
...
/obj/item/clothing/suit/storage/RO
	...
	desc = "A green jacket worn by SFJTF personnel. The back has the flag of the Solarian Federation on it."
